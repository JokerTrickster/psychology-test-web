...
const QuestionPage: React.FC<QuestionPageProps> = ({ node, onSelectOption }) => {
    ...
    return (
        ...
        >
            ...
            {/* Question image with decorative border - HIDDEN ON MOBILE for space */}
            {node.imageUrl && (
                <Paper
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 0.7, sm: 2.5 }, mt: { xs: 0, sm: 1 } }}>
                    ...
                    return (
                        ...
                        >
                            ...
                            <Button
                                ...
                                sx={{
                                    padding: {
                                        xs: '9px 12px',   // 320px - smaller but still touch-friendly
                                        sm: '20px 24px',   // 600px+
                                    },
                                    minHeight: '42px', // Smaller minimum while maintaining accessibility
                                    borderWidth: {
                                        xs: '2px',
                                        sm: '3px',
                                    },
                                    ...
                                    fontSize: {
                                        xs: '0.78rem',    // 320px - more compact
                                        sm: '1.15rem',   // 600px+
                                    },
                                    fontWeight: 600,
                                    borderRadius: { xs: '12px', sm: '28px' },
                                    textAlign: 'left',
                                    position: 'relative',
                                    overflow: 'visible',
                                    boxShadow: isHovered
