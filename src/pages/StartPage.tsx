        ...
        >
            ...
            <Box
                ...
                sx={{
                    ...
                    borderRadius: { xs: '12px', sm: '30px' },
                    padding: {
                        xs: '8px 12px',   // 320px - ultra compact
            ...
            >
                ...
                <Typography
                    ...
                    sx={{
                        ...
                        lineHeight: 1.4,
                        fontSize: {
                            xs: '0.72rem',   // 320px - ultra compact
                            sm: '1.1rem'     // 600px+
                        },
                    }}
                >
